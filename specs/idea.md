...
| Touch targets | Phones are first-class, not a consequence. 96px minimum hit height on every console row, and tap-to-select with a confirm step on the combat grid. In scope for v1, not deferrable. |
