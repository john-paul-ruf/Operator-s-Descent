...
| 02 | Compact PARTY, GEAR, TECH, and LOOT content | M63–M66 | `./src/ui/console/party.js`, `./src/ui/console/gear.js`, `./src/ui/console/tech.js`, `./src/ui/console/loot.js`, `./tests/ui/console-party.test.js`, `./tests/ui/console-gear.test.js`, `./tests/ui/console-tech.test.js`, `./tests/ui/console-loot.test.js`, `./tests/ui/party-gear.test.js` | pending | — | — | Depends on SESSION-01; preserves composite action rows and repairs overwritten scroll-area classes. |
| 03 | Compact COMBAT/LOG chrome and harden the console scroll owner | M60, M62, M67, M103 | `./src/ui/console/console.js`, `./src/ui/console/combat.js`, `./src/ui/console/log.js`, `./tests/ui/console.test.js`, `./tests/ui/console-combat.test.js`, `./tests/ui/console-log.test.js` | pending | — | — | Depends on SESSION-01; concurrent with SESSION-02; protects keyed mode scroll restoration. |
