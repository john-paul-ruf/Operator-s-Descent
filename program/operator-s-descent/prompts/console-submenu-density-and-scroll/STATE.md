...
| 04 | Browser acceptance for dense submenus and reachable scrolling | M95, M97, M99, M103 | `./tests/helpers/console-density-fixture.js`, `./tests/e2e/console-submenu-density.spec.js`, `./tests/e2e/scroll-restore.spec.js`, `./tests/e2e/touch-flow.spec.js`, `./tests/e2e/combat-touch.spec.js`, `./tests/e2e/portrait-usability.spec.js`, `./tests/e2e/adaptive-layout.spec.js` | in-progress | 1/2 + residual | — | Zen collection first yielded an interim non-handoff message, but the original handle remains reattachable and the worker committed a subsequent repair. Re-awaiting the same worker for its final exit-contract JSON. Checkpoint 1 and the session-end residual remain recorded; the earlier outside-lease inclusion remains a lease violation. |
