...
| 04 | Browser acceptance for dense submenus and reachable scrolling | M95, M97, M99, M103 | `./tests/helpers/console-density-fixture.js`, `./tests/e2e/console-submenu-density.spec.js`, `./tests/e2e/scroll-restore.spec.js`, `./tests/e2e/touch-flow.spec.js`, `./tests/e2e/combat-touch.spec.js`, `./tests/e2e/portrait-usability.spec.js`, `./tests/e2e/adaptive-layout.spec.js` | pending | 0/2 recovered | — | Dependencies are done. Zen attempt 1 lost its handle during collection and returned no parseable handoff; no checkpoint commit landed. A fresh recovery worker must handle the surviving uncommitted lease work under MU.md Crash Recovery before continuing browser acceptance. |
