...
| 03 | Compact COMBAT/LOG chrome and harden the console scroll owner | M60, M62, M67, M103 | `./src/ui/console/console.js`, `./src/ui/console/combat.js`, `./src/ui/console/log.js`, `./tests/ui/console.test.js`, `./tests/ui/console-combat.test.js`, `./tests/ui/console-log.test.js` | blocked | 2/2 | 2026-08-22 | Blocked: Zen session handle was lost after launch before persistence, so no final handoff JSON can be retrieved. Git recovery log confirms two SESSION-03 checkpoint commits; SESSION-04 remains stalled. |
