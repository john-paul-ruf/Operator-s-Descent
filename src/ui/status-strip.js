...
export function createStatusBar(runState, combatState = null, options = {}) {
  ...
  // SESSION-01 (portrait-usability-regression-repair) — the status-collapse
  // toggle and the persistent `status-collapsed` class are gone. Combat + explore
  // status must always be fully legible; density is a CSS/layout concern, not a
  // hide-critical-fields concern.
